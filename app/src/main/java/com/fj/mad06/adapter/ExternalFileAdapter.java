...
import com.fj.mad06.SaveExternalActivity;
import com.fj.mad06.SaveLocalActivity;

import java.util.ArrayList;

public class ExternalFileAdapter extends RecyclerView.Adapter<ExternalFileAdapter.ViewHolder> {

    private Context context;
    private ArrayList<String> listFile;

    public ExternalFileAdapter(Context context, ArrayList<String> listFile) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, final int i) {
        ...
        viewHolder.cvItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, SaveExternalActivity.class);
